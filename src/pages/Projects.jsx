...
const Projects = () => {
  return (
    ...
    <div className='mt-5 flex flex-col gap-3 text-slate-500'>
      <p>
      I've embarked on numerous projects throughout the years, but these are the ones I hold closest to my heart. Many of
        ...
        <div className='lg:w-[400px] w-full' key={project.name}>
          ...
          <div className='mt-5 flex flex-col'>
            ...
            <div className='flex items-center gap-2 mt-5 font-poppins'>
              <Link to={project.link} target='_blank' rel='noopenner noreferrer' className='font-semibold text-blue-600'>Live Link</Link>
